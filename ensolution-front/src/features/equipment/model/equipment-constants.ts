...
export const EQUIP_TYPE_TABS: { id: EquipType; label: string }[] = [
  { id: EquipType.PARTICLE_SAMPLER, label: '입자상 시료채취장비' },
  { id: EquipType.GAS_SAMPLER, label: '가스상 시료채취장비' },
...
export const EQUIP_TYPE_LABELS: Record<EquipType, string> = {
  [EquipType.PARTICLE_SAMPLER]: '입자상 시료채취장비',
  [EquipType.GAS_SAMPLER]: '가스상 시료채취장비',
