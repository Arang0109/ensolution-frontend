...
interface CompanyCreateContentProps {
  onClose: () => void;
  onSuccess: () => void;
}

export const CompanyCreateContent = ({ onClose, onSuccess }: CompanyCreateContentProps) => {
  ...
  return (
    <>
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-base md:text-2xl font-bold text-gray-800">업체 추가</h2>
        <IconButton
          icon={<X />}
          title="닫기"
          size="md"
