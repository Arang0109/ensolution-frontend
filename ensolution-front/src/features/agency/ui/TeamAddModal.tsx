import { useTeamForm } from '@agency/hooks/useTeamForm';
...
export const TeamAddModal = ({ onClose, onSuccess }: TeamAddModalProps) => {
  const {
    form,
    isSubmitting,
    onChange,
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-4 pt-4 border-t">
            ...
            <div>
              ...
              {particleSamplers.length === 0 && (
                <p className="text-xs text-gray-400 mt-1">등록된 장비가 없습니다.</p>
              )}
            </div>
